...
#ifndef DATA_MODEL_SCALED_UINT8_LEAF_H
#define DATA_MODEL_SCALED_UINT8_LEAF_H
...
class DataModelScaledUInt8Leaf : public DataModelRetainedValueLeaf {
   private:
        ScaledUInt8 value;
...
#endif // DATA_MODEL_SCALED_UINT8_LEAF_H
