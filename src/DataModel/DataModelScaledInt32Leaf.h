...
#ifndef DATA_MODEL_SCALED_INT32_LEAF_H
#define DATA_MODEL_SCALED_INT32_LEAF_H
...
class DataModelScaledInt32Leaf : public DataModelRetainedValueLeaf {
   private:
        ScaledInt32 value;
...
#endif // DATA_MODEL_SCALED_INT32_LEAF_H
